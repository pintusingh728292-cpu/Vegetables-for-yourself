...
<head>
    ...
    <style>
        ...
        .card img { width: 100%; height: 110px; object-fit: cover; border-radius: 10px; background: #eee; }
...
<div class="container">
    ...
    <div class="sidebar">
        ...
        <div style="background:#f9f9f9; padding:10px; border-radius:10px;">
            ...
            <div id="cartItems" style="margin: 10px 0; font-size: 14px;">थैला खाली है...</div>
            <hr>
...
<script>
    ...
    const items = [
        ...
        { id: 5, name: "लहसुन", price: 160, img: "https://cdn.pixabay.com/photo/2015/05/15/14/51/garlic-768656_640.jpg" },
        { id: 6, name: "भिंडी", price: 50, img: "https://cdn.pixabay.com/photo/2017/08/04/17/36/okra-2580838_640.jpg" },
        { id: 7, name: "धनिया", price: 20, img: "https://cdn.pixabay.com/photo/2016/06/21/20/54/coriander-1471880_640.jpg" },
        { id: 8, name: "बैंगन", price: 30, img: "https://cdn.pixabay.com/photo/2014/10/24/10/58/eggplant-499990_640.jpg" },
        { id: 9, name: "गाजर", price: 40, img: "https://cdn.pixabay.com/photo/2016/08/03/11/08/carrots-1566373_640.jpg" },
        { id: 10, name: "मटर", price: 50, img: "https://cdn.pixabay.com/photo/2015/05/26/17/31/peas-785055_640.jpg" },
        { id: 11, name: "पालक", price: 30, img: "https://cdn.pixabay.com/photo/2017/04/06/20/00/spinach-2209214_640.jpg" },
        { id: 12, name: "मूली", price: 20, img: "https://cdn.pixabay.com/photo/2015/03/24/09/24/radish-687295_640.jpg" },
        { id: 13, name: "शिमला मिर्च", price: 80, img: "https://cdn.pixabay.com/photo/2014/11/05/15/57/bell-peppers-518018_640.jpg" },
        { id: 14, name: "कद्दू", price: 25, img: "https://cdn.pixabay.com/photo/2016/09/16/01/21/pumpkin-1673105_640.jpg" }
    ];
    ...
    function render() {
        document.getElementById('productList').innerHTML = items.map(i => `
            <div class="card">
                <img src="${i.img}" loading="lazy" onerror="this.src='https://via.placeholder.com/150?text=${i.name}'">
                <h4>${i.name}</h4>
                <div style="color:#666; font-size:13px;">₹${i.price}/kg</div>
                <div class="qty-controls">
                    <button class="qty-btn" onclick="updateQty(${i.id}, -0.25)">-</button>
                    <span id="qty-${i.id}" style="font-weight:bold; font-size:14px;">${formatWeight(cart[i.id] || 0)}</span>
                    <button class="qty-btn" onclick="updateQty(${i.id}, 0.25)">+</button>
                </div>
            </div>
        `).join('');
